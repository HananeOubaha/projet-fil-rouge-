...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="bg-white shadow-md rounded-lg overflow-hidden">
        <div class="flex items-center justify-between px-6 py-4 border-b border-gray-200">
            ...
            <a href="{{ route('psychologist.resources.index') }}" 
               class="inline-flex items-center px-4 py-2 bg-pvn-green-500 text-white rounded-md hover:bg-pvn-green-600">
    ...
    <div class="text-center py-8">
        ...
        <a href="{{ route('psychologist.resources.index') }}" 
           class="inline-block mt-4 px-6 py-2 text-white bg-pvn-green-500 rounded-lg hover:bg-pvn-green-600 focus:outline-none focus:ring-2 focus:ring-pvn-green-500 focus:ring-opacity-50">
                    ...
                    <table class="min-w-full divide-y divide-gray-200 text-sm">
                        <thead class="bg-gray-50 text-left text-gray-600 uppercase tracking-wider">
                            <tr>
                                ...
                                <th class="px-4 py-3">Image</th> <!-- Image column -->
